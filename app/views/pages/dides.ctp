<!-- File: /app/views/provinces/pages/diδes.ctp -->
<?php
	echo  $this->element("header", array( "activeTab" => 2) );
	$this->set('title', 'metathesi.gr - Διευθύνσεις Δευτεροβάθμιας Εκπαίδευσης');
?>
...
<div class="btm">
	<div id="page">
		<div id="content" style="float:left">
			<div class="post">
				<h1 class="title">Διευθύνσεις Δευτεροβάθμιας Εκπαίδευσης</h1>
				<div class="entry">
					<p>
